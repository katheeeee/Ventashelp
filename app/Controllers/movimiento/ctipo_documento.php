...
{
    // DEMO: luego lo reemplazas por consulta real a la BD
    private function get_venta_demo($idventa)
    {
        return [
            'idventa' => $idventa,
    ...
    {
        $data = $this->get_venta_demo($idventa);
        $data['tipo'] = 'BOLETA';
        return view('movimientos/documento/vprint', $data);
    }
    ...
    {
        // 1) instala FPDF en app/ThirdParty/fpdf/fpdf.php
        ...
        return $this->response
            ...
            ->setBody($pdf->Output('S')); // devuelve el PDF al navegador
    }
}
